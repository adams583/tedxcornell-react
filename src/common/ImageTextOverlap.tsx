...
interface ImageTextOverlapProps {
  content: string;
  title: string;
  src: string;
  button: string;
...
export const ImageTextOverlap = React.memo(function ImageTextOverlapFn({ src, title, content, button, buttonHref }: ImageTextOverlapProps) {
  return (
